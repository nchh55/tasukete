											...
											<form action="suggestionList" method="get">
												<select name="demo-category" style="height:25px;">
													<option value>- Category -</option>
											 		<option value="userid"  ${searchItem =='userid'?'selected' :'' }>제목</option>
													<option value="userid" ${searchItem =='userid'?'selected' :'' }>글쓴사람</option>
													<option value="userid" ${searchItem =='userid'? 'selected' :'' }>내용</option>
												</select>
									...
									<!-- Paging 시작 -->
										<div class="text-center">
											<ul class="pagination">
												...
												<li><a href="suggestionList?currentPage=${page}&searchItem=${searchItem}&searchWord=${searchWord}">${page}</a></li>
												</c:forEach>
